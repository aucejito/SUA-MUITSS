...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		context.registerService(sondaTipoVia.implInterfacesList.toArray(new String[sondaTipoVia.implInterfacesList.size()]), sondaTipoVia, null);
		
		sondaEstadoVia = new SondaEstadoVia(context);
		context.registerService(sondaEstadoVia.implInterfacesList.toArray(new String[sondaEstadoVia.implInterfacesList.size()]), sondaEstadoVia, null);
	}
